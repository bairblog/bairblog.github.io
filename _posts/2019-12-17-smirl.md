...
visible:            True
show_comments:      False
Cover:              <div align="center">     <table align="center">        <tr>    <td width="25%">        <video width="100%" controls autoplay>   <source src="../projects/SMiRL/biped/treadmill_surpise_ICM_v3_rewardViz.mp4" type="video/mp4"> Your browser does not support the video tag. </video>        </td>    <td width="25%">    <video width="100%" controls autoplay>   <source src="../projects/SMiRL/biped/pedistal_surpise_v3_rewardViz.mp4" type="video/mp4"> Your browser does not support the video tag. </video> </td> <td width="25%">  <img width="100%" src="../projects/SMiRL/miniGrid/minigrid-maze-random-count.gif">           </td>	</tr> </table></div>
---
