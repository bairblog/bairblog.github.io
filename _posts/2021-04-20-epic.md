...
author:             Adam Gleave, Michael Dennis, Shane Legg, Stuart Russell and Jan Leike
...
<br>
<i><b>Figure 1</b>: EPIC compares reward functions $R_u$ and $R_v$ by first mapping them to canonical representatives and then computing the Pearson distance between the canonical representatives on a coverage distribution $\mathcal{D}$. Canonicalization removes the effect of potential shaping, and Pearson distance is invariant to positive affine transformations.</i>
...
<p style="text-align:center;">
<img src="https://bair.berkeley.edu/static/blog/epic/04.png" width="60%">
<br>
<i><b>Figure 4</b>:
