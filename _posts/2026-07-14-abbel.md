...
<i class="abbel-fig-cap">Overview of ABBEL compared to traditional recursive summarization. Beliefs replace the full interaction history as the agent’s working context.</i>
</p>
...
<i class="abbel-fig-cap">Fig. 2: Autoencoder-inspired belief grading. The model encodes (b<sub>t</sub>, a<sub>t</sub>, o<sub>t</sub>) into posterior belief b<sub>t+1</sub> and is rewarded for how well selected history can be reconstructed from that belief.</i>
</p>
