...
author:             <a href="http://mbchang.github.io/">Michael Chang</a> and Sidhant Kaushik
img:                assets/auction/
...
<p style="text-align:center;">
    <img src="./bair_blog_files/figs/abstraction_barrier.png" width="100%">
    <br>
...
<p style="text-align:center;">
    <img src="./bair_blog_files/figs/centralized_gif.gif" width="100%">
    <br>
...
<p style="text-align:center;">
    <img src="./bair_blog_files/figs/decentralized_gif.gif" width="100%">
    <br>
...
<p style="text-align:center;">
    <img src="./bair_blog_files/figs/utility.png" width="75%">
    <br>
...
<p id="hrl_fig" style="text-align:center;">
    <img src="./bair_blog_files/figs/hrl_weight.png" width="90%">
    <br>
...
<p id="mnist" style="text-align:center;">
    <img src="./bair_blog_files/figs/mnist.png" width="75%">
    <br>
...
<ul>
    <li>
        ...
        <br>
        <a href="http://mbchang.github.io/">Michael Chang</a>, Sidhant Kaushik, <a href="https://www.cs.princeton.edu/~smattw/">S. Matthew Weinberg</a>, <a href="http://cocosci.princeton.edu/tom/index.php">Thomas Griffiths</a>, <a href="http://people.eecs.berkeley.edu/~svlevine/">Sergey Levine</a>
        <br>
