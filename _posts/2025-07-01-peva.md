...
* **Action and vision are heavily context-dependent.** The same view can lead to different movements and vice versa—because humans act in complex, embodied, goal-directed environments.
* **Human control is high-dimensional and structured.** Full-body motion spans 48+ degrees of freedom with hierarchical, time-dependent dynamics, not synthetic control codes.
