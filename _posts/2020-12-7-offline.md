...
<p style="text-align:center;">
    ...
    <br>
<i>
Figure 2: Na\"ive Q-function training can lead to overestimation of unseen actions (i.e., actions not in support) which can make bad behavior look promising. By underestimating the Q-value function for unseen actions at a state, CQL ensures that values of unseen behaviors is not overestimated, giving rise to the lower-bound property.
</i>
</p>
