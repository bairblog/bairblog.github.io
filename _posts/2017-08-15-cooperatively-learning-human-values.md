...
gold, runs into a satyr and wishes that everything he touches turned to gold.
...
This video demonstrates a racing strategy that pursues points to the exclusion
of all else, failing to actually _win_ the race. This is clearly distinct from
the *desired* behavior, yet the designers did get exactly the behavior they
asked for.
...
demonstrate particular failure recovery modes. These types of cooperative
...
learning does not provide any guidance on managing this tradeoff.
...
optimizing some giving reward function, the two are cooperating to accomplish a
...
computing solutions to CIRL games, as well as consider extensions to aligning
values with multiple people, each with their own goals and preferences.
