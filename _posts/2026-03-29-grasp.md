...
author: <a href="https://michael-psenka.github.io/">Michael Psenka</a>
img: /assets/grasp/pusht_zoomout.gif
...
> This blogpost discusses work done with Mike Rabbat, Aditi Krishnapriyan, Yann LeCun*, and Amir Bar* (*) equal advisorship, where we propose a new world model planner: [GRASP: Parallel Stochastic Gradient-based Planning for World Models](https://arxiv.org/pdf/2602.00475).
