...
For example, [this paper][4] shows a setting where RL agents are trained in a parallelized fashion using scalable evolutionary algorithms.  The problem is that they are insanely sample inefficient (albeit
...
- <b><a href="https://arxiv.org/abs/1907.10515">arXIv 2019</a></b>
