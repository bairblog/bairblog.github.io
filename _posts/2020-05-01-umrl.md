...
In this work, we show that several recent methods investigating mutual information based skill
discovery [[Achiam 2018][18], [Eysenbach 2018][19], [Gregor 2016][20], [Lee 2019][21], [Sharma 2019][22]]
provide a tractable approximation to the uniform distribution over task distributions. To
...
Thanks to Jake Tyo, Conor Igoe, Sergey Levine, Chelsea Finn, and the MLD and BAIR blog editors for their feedback.
