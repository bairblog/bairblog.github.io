...
First, we collected a large dataset containing demonstrations of a teleoperated expert
...
of many different tasks performed by both teleoperated experts *and* humans. Then, we
